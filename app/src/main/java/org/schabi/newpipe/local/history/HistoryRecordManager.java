...
public class HistoryRecordManager {
    ...
    private boolean isIncognitoEnabled() {
        return sharedPreferences.getBoolean(context.getString(R.string.enable_incognito_key), false);
    }

    private boolean isStreamHistoryEnabled() {
        return !isIncognitoEnabled() && sharedPreferences.getBoolean(streamHistoryKey, false);
    }
    ...
    private boolean isSearchHistoryEnabled() {
        return !isIncognitoEnabled() && sharedPreferences.getBoolean(searchHistoryKey, false);
    }
