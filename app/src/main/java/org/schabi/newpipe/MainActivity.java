...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupDrawerHeader() {
        drawerHeaderBinding.drawerHeaderServiceSwitcher.setOnClickListener(view -> toggleServices());
    ...
    protected void onResume() {
        ...
        try {
            ...
            drawerHeaderBinding.drawerHeaderServiceSwitcher.setContentDescription(
